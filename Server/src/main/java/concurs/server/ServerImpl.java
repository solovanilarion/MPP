...
public class ServerImpl implements IServer{
    ...
    private Map<String, IClient> loggedPers = new ConcurrentHashMap<>();
    ...
    public ServerImpl(IPersoanaOficialaRepository repoPers, IProbaRepository repoProba, IRepository<Integer, Inscriere> repoInscriere,ICopilRepository repoCopil){
        System.out.println("constructor ServerImpl");
    ...
    public synchronized void login(PersoanaOficiala pers, IClient client) throws ConcursException {
        System.out.println("login - ServerImpl");
    ...
    @Override
    public void inscriere (String numeC, String prenumeC, int varstaC, String den1, String cat1, String den2, String cat2, String username) throws ConcursException, RemoteException {
        ...
        if (id2!=-1){
            ...
            repoProba.update(id1, proba2);
            notify(proba2);
        }
    }

    private void notify(Proba proba) throws ConcursException, RemoteException {
