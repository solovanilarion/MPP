...
public interface IServer {
    ...
    //IInscriereService
    void inscriere(String numeC, String prenumeC, int varstaC, String den1, String cat1, String den2, String cat2, String username) throws ConcursException, RemoteException;
